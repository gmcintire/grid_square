...
describe GridSquare::Location do
  # We can use Locations to represent exact points...
  Given(:origin) { GridSquare::Location.new 0.0, 0.0 }

  # Or spans/sizes
  Given(:window) { GridSquare::Location.new -180.0, -90.0 }

  Then { window.longitude.should be_within(0.000001).of -180.0 }
  Then { window.latitude.should be_within(0.000001).of -90.0 }

  context "translation +" do
    Given(:new_origin) { origin + GridSquare::Location.new(50.0, 40.0) }
